...
<body>
	<div class="container-">	
        	...
        	<strong>テーブル名</strong>
        		<select>	
        			<c:forEach items="${tablesList}" var="tn" varStatus="stat">
        				<option value="${tn.identificationNum}">${tn.value}</option>
					</c:forEach>
        ...
        <div>
        	<div>
        		<form:form action="${pageContext.request.contextPath}/manage/updateSuccess" method="POST" modelAttribute="updateSuccessForm">
        			<table border=1>
	        			<thead>
	        			
	        				<c:forEach items="${columnList}" var="cl" varStatus="stat">
	        					<th>
	 								${cl.columnName}
	 							</th> 
							</c:forEach>
	        			...
	        			<tbody>
	        				<tr>
	        					<td><input type="text" value="${selectedRow.stampEventId}" id="stampEventId" disabled></td>
	        					<td>
	        						<select id="stampId">
	        								<option>${selectedRow.stampId}</option>
	        								
	        							<c:forEach items="${stampevent}" var="se" varStatus="stat">
	        								<option>
		        									${se.stampId}
		        							</option>
	        							</c:forEach>
	        					...
	        					<td>
	        						<select id="eventSpace">
	        								<option>${selectedRow.eventSpace}</option>
	        								<c:forEach items="${stampevent}" var="se" varStatus="stat">
	        								<option>
		        									${se.eventSpace}
		        							</option>
	        					...
	        					<td><input type="text" id="eventContents" value="${selectedRow.eventContents}" ></td>
	        					<td><input type="text" id="deleteFlg" value="${selectedRow.deleteFlg}"  disabled></td>
	        				</tr>
        				</tbody>
        			...
        			<div class="clickButton">
	    				...
	    				<input type="submit" value="更新" class="sumit_button"/>	
	    				<input type="submit" value="削除" class="sumit_button"/>
 					</div>
